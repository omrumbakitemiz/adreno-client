...
const styles = theme => ({
  wrapper: {
    background: "radial-gradient(circle, rgba(211,211,211,1) 80%, rgba(0,0,0,1) 200%)",
    height: "100vh",
    ...
    return (
      <Grid container className={classes.wrapper} spacing={0}>
        <Grid item className={classes.userInfo}>
          <div>
            <img className={classes.userImage} src={image ? image : tempAvatar} alt="Avatar" />
          </div>
          <div>
            ...
            <div>
              {selectedUser ?
                <div>
                  ...
                  <p className={classes.chatInfoEmail}>Last seen:
                    <span className={classes.workInProgress} role="img" aria-label="Construction">🚧 🚧 🚧 🚧</span>
                  </p>
                </div> :
                null
              }
